    ...
    add(url, method, parameters, docs, callback) {
        ...
        let func = (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                let argument_result = {};
                argument_result.permissions = (_a = this.getPermissions) === null || _a === void 0 ? void 0 : _a.call(this, req);
                if (Array.isArray(parameters.permissions_required)) {
                    ...
                    yield argument_result.permission;
                ...
                yield argument_result.permissions;
                try {
