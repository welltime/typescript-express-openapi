...
function createDocsStub(info, version, title, projectName, privacyType, tags) {
...
function getApiPath(projectName, privacyType) {
    const settings = { protocol: constants_1.is_dev_env ? 'http' : 'https', basePath: `api/${privacyType}/api` };
    switch (projectName) {
