...
exports.logObject = exports.logMessage = exports.logEvent = exports.logException = exports.Severity = exports.SubTopic = exports.Topic = void 0;
...
function logObject(topic, severity, logObj, subtopic = SubTopic.Unknown) {
    try {
        if (!constants_1.is_dev_env) {
            if (process.env.is_running_tests)
                return;
            console.log(JSON.stringify(Object.assign({ topic,
                subtopic,
                severity, stack: getStack(), logType: LogType.object }, logObj)));
        }
        else {
            console.log(chalk_1.default.green.bold(`logType: ${LogType.object} \nmessage: ${JSON.stringify(logObj)} \n`));
        }
    }
    catch (e) {
        console.log(e);
